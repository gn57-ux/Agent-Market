...
runIfOptedIn("runMigrations (integration)", () => {
  ...
  it("applies all migrations on first run", async () => {
    ...
    expect(result.applied).toEqual([
      ...
      "0031_create_interaction_events.sql",
      "0032_create_ctr_training_datasets.sql",
      "0033_create_ctr_models_and_rerank_observability.sql",
      "0034_add_ctr_models_fusion_weights.sql",
    ]);
