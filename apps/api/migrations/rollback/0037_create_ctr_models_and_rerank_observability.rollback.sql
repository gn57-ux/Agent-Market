-- Manual rollback for 0037_create_ctr_models_and_rerank_observability.sql
...
DELETE FROM schema_migrations WHERE id = '0037_create_ctr_models_and_rerank_observability.sql';
